...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('categories') }}">Institutes</a></li>
                        <li><a href="{{ route('students') }}">Students</a></li>
                        <li><a href="{{ route('admins') }}">Admin</a></li>
                        @else
                        <li><a href="{{ route('dashboard') }}">Dashboard</a></li>
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span> {{ now()->format("Y") }} <a href="https://mcc.edu.ph">Mabalacat City College</a></span>
                </div>
            </div>
        </div>
    </div>
